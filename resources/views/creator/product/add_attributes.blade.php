    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        file_exists("storage/products/".$product['product_image']))
                                ...
                                <form method="POST" role="form" class="text-start"
                                    action="{{ url('creator/add-attributes/'.$product['id']) }}"
                ...
                <form action="{{ url('creator/edit-attributes/'.$product['id']) }}" method="post" role="form">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" record="attribute"
                                                recordId="{{ $item['id'] }}" class="confirm_delete" user="creator">
