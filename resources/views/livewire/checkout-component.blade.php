					...
					<div class="col-md-6">
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									<label class="required" for="email">Email Addreess:</label>
								...
								<p class="row-in-form">
									<label class="required" for="city">Street address</label>
									<input type="text" name="streetaddress" value="" placeholder="Apartment, building, suite, floor, etc"
						...
						<div class="summary summary-checkout">
							<div class="summary-item payment-method">
								...
								<div class="choose-payment-methods">
									...
									<label class="payment-method">
										<input name="payment-method" id="payment-method-paypal" value="telebirr"
