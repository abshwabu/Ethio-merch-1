      ...
      <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
        ...
        <div class="wrap-shop-control">
          ...
          <div class="wrap-right">
            ...
            <div class="sort-item orderby form-group">
              <select name="orderby" class="use-chosen form-control select2" wire:model="sorting">
            ...
            <div class="sort-item product-per-page" wire:model="pagesize">
              <select name="post-per-page" class="use-chosen form-control select2">
