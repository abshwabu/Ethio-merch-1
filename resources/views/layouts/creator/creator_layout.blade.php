...
<head>
  ...
  <link rel="stylesheet"
    href="{{ url('assets/plugins/admin_plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- Select2 -->
  <link rel="stylesheet" href="{{ url('assets/plugins/admin_plugins/select2/css/select2.min.css') }}">
  <link rel="stylesheet"
    href="{{ url('assets/plugins/admin_plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
  <!-- iCheck -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet"
    href="{{ url('assets/plugins/admin_plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
  <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- Tempusdominus Bootstrap 4 -->
  <script src="{{url('assets/plugins/admin_plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}">
  </script>
  <!-- Summernote -->
