                ...
                <div class="row">
                  ...
                  <div class="col-md-6 my-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number " class="form-control @error('regular price') is-invalid @enderror"
                        name="regular price" @if (!empty($productData->regular_price)) value="{{ $productData->regular_price }}"
                  ...
                  <div class="col-md-6 my-2">
                    <div class="form-group my-2">
                      ...
                      <a href="javascript:void(0)" class="updateProductFeatured" id="product2-{{ $productData->id }}" product_id2= "{{ $productData->id }}">{{ $productData->is_is_featured == '1' ? 'Yes' : 'No' }}</a>
