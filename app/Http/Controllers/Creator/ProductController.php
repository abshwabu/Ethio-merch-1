...
class ProductController extends Controller
{
    public function product()
    {
        ...
        return view('creator.product.product', compact('product'));
    }
    ...
    public function addEditProduct(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect('creator/products');
        }
        ...
        return view('creator.product.add_edit_product', compact('title', 'categories', 'productData'));
    }
    ...
    //         return view('creator.product.append_categories_level', compact('getCategories'));
    //     }
    // }
    ...
    public function addAttributes(Request $request, $id = null)
    {
        ...
        return view('creator.product.add_attributes')->with(compact('product', 'title'));
    }
    ...
    public function addImages(Request $request, $id = null)
    {
        ...
        return view('creator.product.add_images')->with(compact('product', 'title'));
    }
